...
import PostDetailSection from "@components/Section/PostDetailSection";
import CommentListCard from "@components/Card/CommentListCard";
import CommentWriteButton from "@components/Button/CommentWriteButton";
...
export default function CommunityDetail(props: CommunityDetailProps) {
    ...
    <div className="page">
      ...
      <div className="body">
        <div className="PostContainer">
          <PostDetailSection data={samplePostData} />
        </div>
        ...
        <div className="CommentListContainer">
          <CommentListCard data={sampleCommentData} />
        </div>
      </div>
